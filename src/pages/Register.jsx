                ...
                <form className="flex flex-col gap-4 sm:gap-5" onSubmit={handleSubmit(onSubmit)}>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-3">
                        <div className="flex-1">
                            ...
                            <Input type="text" id="firstName" placeholder="John" {...register("firstName", { required: true })} />
                        </div>
                        <div className="flex-1">
                            <Label htmlFor="lastName">Last Name</Label>
                            <Input type="text" id="lastName" placeholder="Doe" {...register("lastName", { required: true })} />
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <Input type="password" id="confirmPassword" placeholder="••••••••" {...register("confirmPassword", { required: true })} />
                    </div>
